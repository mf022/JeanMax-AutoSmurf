...
function LoadConfig() {
	...
	*/
	...
	//-----usual-------- 
	Config.PickitFiles.push("autoOtherSmurf/charms.nip");
	Config.PickitFiles.push("autoOtherSmurf/magic.nip");
	Config.PickitFiles.push("autoOtherSmurf/rare.nip");
	Config.PickitFiles.push("autoOtherSmurf/runes.nip");
	Config.PickitFiles.push("autoOtherSmurf/runeword.nip");
	Config.PickitFiles.push("autoOtherSmurf/set.nip");
	Config.PickitFiles.push("autoOtherSmurf/unique.nip");	
	Config.PickitFiles.push("autoOtherSmurf/sell.nip");
	Config.PickitFiles.push("autoOtherSmurf/merc.nip");
	//-----special--------
	Config.PickitFiles.push("autoOtherSmurf/sorceress.xpac.nip");
	//Config.PickitFiles.push("autoOtherSmurf/paladin.xpac.nip");
	//Config.PickitFiles.push("autoOtherSmurf/barbarian.xpac.nip");
	Config.PickitFiles.push("autoOtherSmurf/white1.nip");
	//Config.PickitFiles.push("autoOtherSmurf/white2.nip"); // advance white1.nip
